...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer les paramètres du site (public)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mettre à jour les paramètres du site (ADMIN only)' }),
